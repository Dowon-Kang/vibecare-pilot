...
| Flutter 전체 테스트 | 41/41 통과 (2026-09-18 프로필 주의사항·골격근 등급/직전값 비교·인체 직접 선택·320px·글자 2배 포함) | 실패 0 |
| 백엔드 TypeScript | 통과 | 오류 0 |
| Flutter format/analyze | V: 영문 경로에서 format·analyze 통과 (2026-09-18) | 오류 0 |
| Flutter debug APK | V: 영문 경로 로컬 debug APK 빌드 통과 (2026-09-18) | 빌드 실패 0 |
...
- [x] 최신 API 골격근량의 낮음·중간·높음 연구 등급과 DB 직전 기록 대비 변화 표시
- [x] 장치 보내기 선택 후 인체 부위와 등급별 연구용 시간·Hz 매핑을 API 승인 설정과 분리 표시
...
- [x] 사용 후 정상 경로 2문항, 필요 시 강도·시간·주파수 및 통증·어지럼 상세 수집(RPE 선택 필드)
