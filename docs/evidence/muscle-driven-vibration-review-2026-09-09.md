...
문헌에서 근육량 LOW/MEDIUM/HIGH를 특정 장치 명령에 직접 연결한 표준은 확인되지 않았다. `12/16/20Hz`, `180/240/300초`, `30/40/50%`는 현재 `pilot-0.6.0` Mock 시뮬레이션에서만 활성화한 검증 대상 연구가설이며, 임상 처방이나 물리 기기 실행 규칙이 아니다.
...
- 장치는 발판형 전신진동으로 확인했지만 수직형/교대형, 파형, 변위, 자세와 부하 조건은 미확정
