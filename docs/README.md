...
4. [pilot-0.7.0 알고리즘 설계](algorithm/pilot-0.7.0-design.md): 현재 구현의 수식, 안전 경계와 추적성
5. [pilot-0.6.0 설계 심사](algorithm/pilot-0.6.0-design-review.md): 이전 버전 감사 기록
...
`pilot-0.7.0`은 연구용 시뮬레이션입니다. 테스트 통과는 코드 재현성을 뜻하며 임상 효과나 실장비 안전을 증명하지 않습니다.
