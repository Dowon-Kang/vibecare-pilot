...
class HumanBodyMap extends StatelessWidget {
    ...
    return Semantics(
      ...
      child: largeText
          ? Column(
              ...
              children: [
                _bodyCanvas(horizontalPadding: 28),
          ...
          : Row(
              ...
              children: [
                Expanded(flex: 5, child: _bodyCanvas(horizontalPadding: 10)),
                const SizedBox(width: 10),
                Expanded(flex: 7, child: _partGrid(columns: 2)),
              ],
            ),
    );
  }

  Widget _bodyCanvas({required double horizontalPadding}) => Container(
    height: 160,
  ...
  Widget _partGrid({required int columns}) => LayoutBuilder(
...
class _HumanSilhouettePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    const neutral = Color(0xFFDCE7E4);
    const outlineColor = Color(0xFF9AB7B0);
    final selectedColor = AppColors.primary.withValues(alpha: .60);
    final wholeBodyColor = AppColors.primary.withValues(alpha: .28);
